...
def load_merged_sources(defaults_dir: Path, config_dir: Optional[Path] = None) -> List[Dict[str, Any]]:
    ...
    Merge Logic:
        ...
        2. If config_dir provided and has fixed-sources.json, load user overlay
    ...
    config_candidates = [
        config_dir / "fixed-sources.json",
        config_dir / "tech-news-digest-sources.json",
    ]
...
def load_merged_topics(defaults_dir: Path, config_dir: Optional[Path] = None) -> List[Dict[str, Any]]:
    ...
    Merge Logic:
        ...
        2. If config_dir provided and has display-topics.json, load user overlay
    ...
    config_candidates = [
        config_dir / "display-topics.json",
        config_dir / "tech-news-digest-topics.json",
    ]
